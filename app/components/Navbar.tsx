      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
             ...
             <Link href="/#skills" onClick={() => setIsOpen(false)} className="text-3xl font-bold text-white">Skills</Link>
             <Link href="/#experience" onClick={() => setIsOpen(false)} className="text-3xl font-bold text-white">Experience</Link>
             <Link href="/#projects" onClick={() => setIsOpen(false)} className="text-3xl font-bold text-white">Projects</Link>
